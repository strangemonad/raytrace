--[[ 
A simple scene demonstrating reflection. Each successive render increases 
the maximum recursion number. After a certain number of recursions the 
difference in the image is not noticeable. Of course a recursion of 0 will 
produce an image with no reflection and any recursion higher than 1 will only
affect scenes that have more than 1 reflective solid both in line of sight of
each other.
]]
...
gr.render(scene_root, 'Reflection-500x500-r0.png', 500, 500,
	  {0, 0, 800}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.0, 0.0, 0.0}, {white_light})
     
gr.enableRayRecursions(1)
gr.render(scene_root, 'Reflection-500x500-r1.png', 500, 500,
	  {0, 0, 800}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.0, 0.0, 0.0}, {white_light})

gr.enableRayRecursions(2)
gr.render(scene_root, 'Reflection-500x500-r2.png', 500, 500,
	  {0, 0, 800}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.0, 0.0, 0.0}, {white_light})
     
gr.enableRayRecursions(3)
gr.render(scene_root, 'Reflection-500x500-r3.png', 500, 500,
	  {0, 0, 800}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.0, 0.0, 0.0}, {white_light})
     
gr.enableRayRecursions(10)
gr.render(scene_root, 'Reflection-500x500-r10.png', 500, 500,
	  {0, 0, 800}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.0, 0.0, 0.0}, {white_light})
     
gr.enableStratifiedSampling(10)
gr.render(scene_root, 'Reflection-1000x1000-reference.png', 1000, 1000,
	  {0, 0, 800}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.0, 0.0, 0.0}, {white_light})
