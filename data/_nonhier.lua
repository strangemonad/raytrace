...
reflectiveMat = gr.rtMaterial(gr.constantTexture({0.9, 0.9, 0.9}), 
                              {0.9, 0.9, 0.9}, 
                              5,
                              0.9,
                              1.0,
...
transMat = gr.rtMaterial(gr.constantTexture({0.7, 1.0, 0.7}), 
                              {0.9, 0.9, 0.9}, 
                              5,
                              0.0,
                              0.5,
...
s1:set_material(reflectiveMat)

s2 = gr.nh_sphere('s2', {100, 50, -100}, 150)
scene_root:add_child(s2)
s2:set_material(transMat)

s3 = gr.nh_sphere('s3', {0, -1200, -500}, 1000)
--scene_root:add_child(s3)
s3:set_material(reflectiveMat)
