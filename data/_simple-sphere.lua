...
root = gr.sphere('s')
root:scale(10, 10, 10)
root:translate(12, 5, 0)
root:set_material(mat1)
...
white_light = gr.light({-100.0, -150.0, 200.0}, {0.9, 0.9, 0.9}, {1, 0.5, 0})
orange_light = gr.light({400.0, 100.0, 150.0}, {0.7, 0.0, 0.7}, {1, 0, 0})
blue_light = gr.light({0.0, 100.0, 20.0}, {0.0, 0.0, 0.4}, {1, 0, 0})

gr.render(scene_root, 'simple.png', 512, 512,
	  {0, 0, 170}, {0, 0, -1}, {0, 1, 0}, 40,
	  {0.0, 0.0, 0.0}, {white_light, orange_light, blue_light})
